...
// //   } else {
// //     str = `Оставшиеся студенты: ${rest.join(", ")}`;
// //   }
// //   result.push(a, b, c, str);

// //   return result;
// // }
// // console.log(sortStudentsByGroups(students));
// // //========================================================================================================================================================
// // // Напишите функцию sortBooksByShelves(arr), которая:
// // // Сначала сортирует книги по алфавиту.
// // // Затем распределяет их по полкам:
// // // первая полка — первые 4 книги;
// // // вторая полка — следующие 4 книги;
// // // третья полка — следующие 2 книги;
// // // все остальные книги считаются непринятыми и попадают в отдельный список.
// // // Функция должна вернуть массив такого вида:
// // // [
// // //     ["CSS", "Express", "Git", "HTML"],
// // //     ["JavaScript", "MongoDB", "Node.js", "React"],
// // //     ["Sass", "TypeScript"],
// // //     "Непринятые книги: Webpack"
// // // ]
// // // Если лишних книг нет
...
// //   "Sass",
// // ];
// // function sortBooksByShelves(arr) {
// //   arr.sort();
// //   let result = [];
...
// //     arr.slice(4, 8),
// //     arr.slice(8, 10),
// //     `Непринятые книги: ${arr.slice(10).length === 0 ? "-" : arr.slice(10).join(", ")}`,
// //   );

// //   return result;
// // }

// // console.log(sortBooksByShelves(books));
...
// // //========================================================================================================================================================
// // // Напиши функцию createCounter(), которая создает счетчик.

// // // Требования:

// // // При каждом вызове возвращаемой функции число должно увеличиваться на 1.
// // // Переменная счетчика должна быть недоступна напрямую снаружи.
// // // Каждый созданный счетчик должен быть независимым.

// // // Пример использования:

// // // Подсказка (если застрянешь)
// // // Тебе нужно сделать примерно такую структуру:
...
// // // функция createCounter уже закончила работу.

// // // Но почему-то внутренняя функция все равно должна помнить про:
